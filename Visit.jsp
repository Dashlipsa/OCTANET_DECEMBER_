...
<header>
  ...
  <div class="dropdown-content">
    ...
    <div class=" profile-box">
    	...
    	<img src="newyork.jpeg" class="place-icon1">
    	<img src="india.jpeg" class="place-icon2">
    	<img src="london.jpeg" class="place-icon3">
    		<h3>No research without action, no action without research</h3>
    		<p>Our College is a highly selective for docterate degree
                college that emphasizes good practice and Experience.</p>
    	
    </div>

    	<div class="socialmedia">
    		<a href="https://www.facebook.com/centurionuniversity/"><i class="fa-brands fa-facebook fa-3x" ></i></a>
    		<a href="https://www.instagram.com/cutmodisha/"><i class="fa-brands fa-instagram fa-3x"></i></a>
    		<a href="https://github.com/dashboard"><i class="fa-brands fa-github fa-3x"></i></a>
    		<a href="https://www.linkedin.com/in/lucky-dash-a855ba23a/"><i class="fa-brands fa-linkedin fa-3x"></i></a>
    	</div>
    </div>
    </section>
